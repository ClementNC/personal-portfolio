...
function NoteCard({ card }: NoteCardProps) {
  return (
    <Link
      href={card.href}
      className="flex-shrink-0 w-[185px] bg-(--bg-card) [border:var(--border-default)] hover:[border-color:var(--border-color-hover)] rounded-[6px] px-4 py-[14px] transition-colors duration-200 cursor-pointer"
    >
